...
|------|-----------------|--------------|-----------------|
| 1. Inherit up not push down | Eng leaders, platform teams — "multi-repo governance" | Strong — solves real pain | 1st — the pattern |
| 2. Three sources of improvement | CPTOs, process leaders — "continuous improvement" | Medium — more conceptual | 2nd — the vision |

**Recommended sequence**: 1 → 2 (pattern → vision)
